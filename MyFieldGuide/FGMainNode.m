...
@implementation FGMainNode


-(NSString *) description
{
    NSMutableString *result = [[NSMutableString alloc] init];
    [result setString:@"This is a MainNode:\n"];
    ...
    [result appendFormat:@"the Description is:\n%@\n", self.nodeDescription];
    [result appendFormat:@"The sons are:\n"];
...
-(void)addOwn:(NSString *) ownName
{
    if (self.owns == nil)
    {
        self.owns = [[NSMutableArray alloc] init];
    }
    [self.owns addObject:ownName];
}
